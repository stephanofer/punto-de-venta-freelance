/**
 * v0 by Vercel.
 * @see https://v0.dev/t/GpgEH8RRSSK
      ...
      <main className="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">$5,185.19</div>
            </CardContent>
          </Card>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Cash flow over the last 6 months</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>Daily sales deposit</TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>Cash In</TableCell>
                    <TableCell>Customer refund</TableCell>
                  </TableRow>
                  <TableRow>
